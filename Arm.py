# The following code is from https://github.com/Chasexj/robotic_surgery/tree/master/src/ros/modified_arm/InvKin
...
class Arm3Link:
    ...
    def __init__(self, q=None, q0=None, L=None):
        ...
        # arm segment lengths
        self.L = np.array([12, 12, 12]) if L is None else L
